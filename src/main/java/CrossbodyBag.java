...
public class CrossbodyBag extends Bag{
    ...
    public CrossbodyBag(String color, int capacity, int num_of_strap) {
        /**
         * This is how we call the parent's constructor
         * The Python equivalent is super().__init__(...)
         */
        super(color, capacity);
        this.numberOfStraps = num_of_strap;
    }
    ...
    public String toString(){
        return this.getColor() + " Crossbody Bag with " + this.getNumberOfStraps() + " straps (0 / 4)";
    }
